...
class NivelEspanolActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_nivel_espanol)
        ...
        btnBasico.setOnClickListener {
            irAPreguntas("espanol", "basico")
        }

        btnMedio.setOnClickListener {
            irAPreguntas("espanol", "medio")
        }

        btnAvanzado.setOnClickListener {
            irAPreguntas("espanol", "avanzado")
        }
    }
